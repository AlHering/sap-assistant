...
****************************************************
"""
from scraping_service.utility import selenium_utility
...
class SeleniumWebsiteArchiver(WebsiteArchiver):
    ...
    def __init__(self, profile: dict) -> None:
        ...
        self._cache["driver"] = selenium_utility.get_driver(**profile.get("framework_arguments", {}))
    ...
    def archive_website(self) -> None:
        ...
        if any(base in self._cache["current_link"] for base in self.allowed_bases):
            ...
            self.register_page(self._cache["last_link"], self._cache["current_link"], response.page_source)
            ...
            for link in target_assets:
                if link not in self.crawled_assets:
                    ...
                    self.register_asset(self._cache["current_link"], link, *self.get_asset_data(link))
